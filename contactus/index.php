...
<body>
    ...
    ?>
    <div class="card mb-3 border-0 shadow-lg" style="max-width: 1000px; margin:0 auto; margin-top: 150px">
        <div class="card-header text-white" style="background-color: #F50057">
            <h5>Contact Us<h5>
        </div>
        <div class="row no-gutters">
            <div class="col-md-6 p-5 my-5">
                <img src="side.svg" class="card-img img-fluid" alt="side image">
            </div>
            <div class="col-md-6 p-3">
                <div class="card-body">
                    ...
                    <form action="/index.php" method="post">
                        ...
                        <button type="submit" class="btn rounded-0 btn-block text-white" style="background-color: #F50057">Send</button>
                    </form>
                </div>
            </div>
        </div>
